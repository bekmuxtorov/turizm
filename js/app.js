...
indicator1 = document.querySelector('.indicator1');
// console.log(indicator1.style.display != 'none')


if (indicator1.style.display == 'none'){
    indicator1.classList.remove('indicator')
}
